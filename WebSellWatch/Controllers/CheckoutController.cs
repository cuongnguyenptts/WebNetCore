...
namespace WebSellWatch.Controllers
{
    public class CheckoutController : Controller
    {
        ...
        public CheckoutController(dbWatchesContext context, INotyfService notyfService)
        {
            _context = context;
            ...
            try
            {
                ...
                if (!ModelState.IsValid)
                {
                    ...
                    foreach (var item in cart)
                    {
                        ...
                        orderDetail.Amount = (int?)item.amout;
                        orderDetail.TotalMoney = donhang.TotalMoney;
                        orderDetail.Price = item.product.Price;
                        orderDetail.CreateDate = DateTime.Now;
                        _context.Add(orderDetail);
                    }
                    /* var productUD = _context.Products.Find(x => x.ProductId);*/
                    _context.SaveChanges();
                    //clear gio hang
