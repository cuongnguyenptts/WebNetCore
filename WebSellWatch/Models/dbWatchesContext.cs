...
{
    public partial class dbWatchesContext : DbContext
    {
        public dbWatchesContext()
        {
        }

        public dbWatchesContext(DbContextOptions<dbWatchesContext> options)
            : base(options)
        {
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Role>(entity =>
            {
                entity.HasKey(e => e.RolesId)
                    .HasName("PK__Roles__C4B27820454161C2");
